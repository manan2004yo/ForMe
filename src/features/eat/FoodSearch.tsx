  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      ...
      >
        ...
        {/* Category Filter Removed - Global Search Enabled */}

        {/* Food List */}
        <div className="overflow-y-auto" style={{ maxHeight: '55vh' }}>
          {isSearching ? (
             <div className="flex flex-col items-center justify-center py-12 text-center">
               <div className="text-sm text-text-tertiary">Searching global database...</div>
             </div>
          ) : searchResults.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              <div className="text-4xl mb-3">🔍</div>
              <div className="font-medium text-text-primary mb-1">No foods found</div>
              <div className="text-sm text-text-tertiary">Try a different search term (e.g. Bread)</div>
            </div>
          ) : (
        ...
        {/* Footer info */}
        <div className="p-3 text-center border-t border-border bg-bg-surface sticky bottom-0">
          <p className="text-xs text-text-tertiary">
            Powered by Open Food Facts Global Database
          </p>
        </div>
      </div>
    </div>
