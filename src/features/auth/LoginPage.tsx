...
export function LoginPage() {
  ...
  return (
    <div className="relative min-h-dvh flex items-center justify-center">
      ...
      {/* Form Container */}
      <div className="relative z-10 w-full max-w-lg mx-auto px-6 py-12 flex flex-col">
        {/* Header */}
        <div className="pb-8">
          ...
          <h1 className="font-heading font-bold text-3xl text-white drop-shadow-md mb-2">Welcome back</h1>
          <p className="text-text-secondary drop-shadow">Sign in to continue your journey</p>
        </div>

        {/* Form */}
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 bg-bg-surface/40 backdrop-blur-md p-6 rounded-3xl border border-white/5">
          {error && (
          ...
          <div>
            ...
            <input
              id="login-email"
              type="email"
              className="input-field bg-black/40 border-white/10"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="input-field pr-12 bg-black/40 border-white/10"
          ...
          <div className="flex items-center gap-2 mt-1">
            <input
              ...
              className="w-4 h-4 rounded border-white/10 text-accent focus:ring-accent bg-black/40"
            />
        ...
        <button
          ...
          disabled={isLoading}
          className="btn bg-bg-surface/40 backdrop-blur-md border border-white/5 hover:bg-bg-surface/60 btn-lg w-full text-white"
        >
        ...
        {/* Sign up link */}
        <p className="text-center text-text-secondary drop-shadow text-sm mt-8 pb-8">
          New to FORME?{' '}
          <Link to="/signup" className="text-accent font-medium hover:text-white transition-colors">
            Create account
          </Link>
        </p>
      </div>
